...
- [x] **3. "我的" 页面**
  - [x] 3.1 创建 `app/routes/profile.tsx` 页面
  - [x] 3.2 实现每日目标设置 UI（10/20/30/50 可选）
  - [x] 3.3 实现学习统计展示（总学习词数、今日学习、连续学习天数、正确率）
  - [x] 3.4 添加生词本入口

- [x] **4. 生词本功能**
  - [x] 4.1 创建 `app/routes/favorites.tsx` 页面
  - [x] 4.2 实现生词列表展示（按添加时间排序）
  - [x] 4.3 在学习/复习页面添加 "加入生词本" 按钮
  - [x] 4.4 实现生词本专项复习功能

- [x] **5. 首页优化**
  - [x] 5.1 在 LearningDashboard 添加每日目标进度显示
  - [x] 5.2 目标达成时显示庆祝动画
  - [x] 5.3 单元列表改为可折叠分组展示（5 个一组）

- [x] **6. 底部导航更新**
  - [x] 6.1 修改 `BottomNav.tsx` 添加 "我的" Tab
  - [x] 6.2 路由配置已包含 profile 和 favorites 路由

- [x] **7. 整体 UI 统一**
  - [x] 7.1 测试页面 UI 风格已统一
  - [x] 7.2 学习页面 (learn.tsx) UI 已优化
